    ...
    val consumer = new Thread(() => {
      ...
      while (true) {
        buffer.synchronized {
          ...
          // there must be at leasy ONE value in the buffer
          val x = buffer.dequeue()
          println("[consumer] consumed " + x)

          // hey producer there is empty space available,  make it
          buffer.notify()
    ...
    val producer = new Thread(() => {
      ...
      while (true) {
        buffer.synchronized {
          ...
          // there must be at leasy ONE EMPTY SPACE in the buffer
