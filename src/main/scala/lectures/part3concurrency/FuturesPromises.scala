...
/**
  * Created by soner.guzeloglu onn 26.08.2019
  */
object FuturesPromises extends App {
  ...
  object BankingApp {
    ...
    def purchase(username: String, item: String, merhantName: String, cost: Double): String = {
      ...
      val transactionStatusFuture = for {
        ...
        transaction <- createTransaction(user, merhantName, cost)
